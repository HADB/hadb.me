...
<template>
  <NuxtLink v-if="post?._dir === 'posts'" :to="post._path" class="block px-6 py-8 border not-prose rounded-lg border-slate-200 dark:border-slate-700 hover:bg-slate-200/30 dark:hover:bg-slate-700/30 group" :class="{ 'text-right': type === 'prev' }">
